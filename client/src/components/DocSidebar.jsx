                    ...
                    <div className="space-y-2">
                        {documents.map((doc) => {
                            ...
                            return (
                                <div
                                    key={doc._id}
                                    className={`group flex items-center gap-2 p-3 rounded-xl transition-colors ${
                                        multiSelect && isSelected
                                            ? "bg-indigo-50 border border-indigo-200"
                                            : "bg-slate-50 hover:bg-indigo-50 border border-transparent hover:border-indigo-100"
                                    }`}
                                >
                                    {multiSelect && (
                                        <input
